    ...
    <div className='fixed w-full  h-full bg-slate-200 bg-opacity-35 top-0 left-0 right-0 bottom-0 flex justify-center items-center z-20'>
       <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
            ...
            <div className='flex justify-between items-center pb-3'>
                ...
                <div className='w-fit ml-auto text-2xl hover:text-primary-600 cursor-pointer' onClick={onClose}>
                    <CgClose/>
                </div>
            </div>
          ...
          <label htmlFor='productName'>Product Name :</label>
            ...
            <label htmlFor='brandName' className='mt-3'>Brand Name :</label>
              ...
              <div>
                  {
                    data?.productImage[0] ? (
                      ...
                      <p className='text-primary-600 text-xs'>*Please upload product image</p>
                    )
                  }
              ...
              <button className='px-3 py-2 bg-primary-600 text-white mb-10 hover:bg-primary-700'>Update Product</button>
          </form>
